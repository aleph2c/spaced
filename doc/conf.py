...
import sys
import datetime
sys.path.insert(0, os.path.abspath('./../spaced'))
...
latex_documents = [
    (master_doc, 'spaced.tex', 'spaced Documentation',
     'Scott Volk', 'manual'),
]
...
man_pages = [
    (master_doc, 'spaced', 'spaced Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'spaced', 'spaced Documentation',
     author, 'Scott Volk', 'spaced repetition with Python3',
     'Miscellaneous'),
]
